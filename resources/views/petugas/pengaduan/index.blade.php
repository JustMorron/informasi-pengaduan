...
@section('page-title')
    ...
    <p class="text-subtitle text-muted">Ini adalah halaman laporan data pengaduan</p>
@endsection
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        <a href="{{ route('kelola-laporan-petugas') }}">Pengaduan</a>
    </li>
                            ...
                            <tr class="border-t">
                                ...
                                <td class="px-4 py-2">
                                    <div class="d-flex flex-nowrap">
                                        <a href="{{ route('petugas-pengaduan-show', $complaint->id) }}"
