...
@section('page-title')
    ...
    <p class="text-subtitle text-muted">Ini adalah halaman detail data pengaduan</p>
@endsection
            ...
            <div class="card-content">
                <div class="card-body">
                    <form class="form form-horizontal" method="POST"
                        action="{{ route('admin-pengaduan-update', $complaints->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-md-8 form-group">
                                    <input type="text" id="first-name" class="form-control" name="name" readonly
                                ...
                                <div class="col-md-8 form-group">
                                    <input type="text" id="first-name" class="form-control" name="judul" readonly
                                ...
                                <div class="col-md-8 form-group">
                                    ...
                                    <textarea id="first-name" class="form-control" name="isi_complaint" readonly>{{ $complaints->isi_complaint }}</textarea>
                                ...
                                <div class="col-md-8 form-group">
                                    <input type="text" id="first-name" class="form-control" name="jenis_pengaduan"
                                        readonly value="{{ $complaints->jenis_pengaduan }}">
                                </div>
                                <div class="col-md-4">
                                    <label>Instasi Tujuan</label>
                                </div>
                                <div class="col-md-8 form-group">
                                    <input type="text" id="first-name" class="form-control" name="instansi" readonly
                                ...
                                <div class="col-sm-12 d-flex justify-content-end">
                                    <a href="{{ route('kelola-pengaduan-admin') }}"
